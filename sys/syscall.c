...
static const syscall_handler_fn syscall_table[SYSCALL_TABLE_SIZE] = {
    ...
    [SYS_RENAME] = handle_sys_rename,
    [SYS_MKDIR] = handle_sys_mkdir,
    [SYS_UNLINK] = handle_sys_unlink,
    [SYS_CHMOD] = handle_sys_chmod,
    [SYS_FCHMOD] = handle_sys_fchmod,
    [SYS_CHOWN] = handle_sys_chown,
    [SYS_FCHOWN] = handle_sys_fchown,
    [SYS_LCHOWN] = handle_sys_lchown,
    [SYS_UMASK] = handle_sys_umask,
    ...
    [SYS_GETGROUPS] = handle_sys_getgroups,
    [SYS_SETGROUPS] = handle_sys_setgroups,
    ...
    [SYS_FCHOWNAT] = handle_sys_fchownat,
    [SYS_FCHMODAT] = handle_sys_fchmodat,
