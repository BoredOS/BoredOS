...
#if defined(BOREDOS)
	/*
	 * The BoredOS port currently presents a plain 32bpp framebuffer through
	 * libui. Keep the simple blitter selected until the port has validated the
	 * animated/SSE blitters and their extra buffer/invalidation requirements.
	 */
	return false;
#endif
