 ...
 */
[[maybe_unused]] static void NetworkUDPBroadCast(NetworkUDPSocketHandler &socket)
{
...
{
#if defined(BOREDOS)
	Debug(net, 1, "BoredOS: UDP LAN server discovery is not available");
	return;
#else
...
{
#if defined(BOREDOS)
	Debug(net, 3, "BoredOS: skipping UDP listeners");
